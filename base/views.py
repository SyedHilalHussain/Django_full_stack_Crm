...
# {'id': 2, 'name':'Design for me!'},
# {'id': 3, 'name':'Let design frontend'},
# {'id': 4, 'name':'Lets start project'},
...
def room(request,pk):
    ...
    context ={'room':room ,'room_messages':room_messages , 'participant': participants}
